...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row" id="dvSearch">
            ...
            <div class="col-md-3">
                <asp:Label ID="lblRole" runat="server" AssociatedControlID="ddlRole" Text="Program Role"></asp:Label>
                <telerik:RadDropDownList ID="ddlRole" runat="server">
                    <Items>
                        <telerik:DropDownListItem Text="All" Value="All" />
                        <telerik:DropDownListItem Text="User/Applicant" Value="User" />
                        <telerik:DropDownListItem Text="Admin" Value="Admin" />
                        <telerik:DropDownListItem Text="Grant Counsel" Value="AdminGC" />
                    </Items>

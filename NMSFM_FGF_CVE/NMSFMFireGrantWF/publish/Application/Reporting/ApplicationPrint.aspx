    ...
    <form id="form1" runat="server">
        <div id="toolbar" class="toolbar">
            <ul>
                ...
                <li>
                    <asp:LinkButton ID="btnSavePDF" runat="server" Text="Download PDF" OnClick="btnSavePDF_Click"></asp:LinkButton>
                </li>
            </ul> 
            </div>
        <asp:HiddenField ID="hfApplicationId" runat="server" />
        <div id="dvApplication" runat="server">
            ...
            <div id="dvSignaturesAcknowledgments">
                <table class="sectionTable">
                    <tr>
                        <td colspan="5" class="sectionTitle">
                            <b>ACKNOWLEDGEMENT/SIGNATURES</b>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Name of Department/District:<br />
                            <span id="spDepartmentName2" runat="server"></span>
                        </td>
                        <td colspan="2" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            County: 
                            <span id="spCounty2" runat="server"></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Name of Fire Chief (please print):<br />
                            <span id="spFireChiefName" runat="server"></span>
                        </td>
                        <td colspan="2" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Signature of Fire Chief: <br />
                            <span id="spFireChiefSignature" style="font-family:'Brush Script Std'; " runat="server"></span>
                        </td>
                        <td style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Date: <br />
                            <span id="spFireChiefSignatureDate" runat="server"></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Name/Title of County/Municipal Fiscal Agent (please print):<br />
                            <span id="spFiscalAgentTitleName" runat="server"></span>
                        </td>
                        <td colspan="2" style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Signature of Fiscal Agent: <br />
                            <span id="spFiscalAgentSignature2" style="font-family:'Brush Script Std';" runat="server"></span>
                        </td>
                        <td style="border:1px solid black; padding: 10px 5px 5px 5px">
                            Date: <br />
                            <span id="spFiscalAgentSignatureDate" runat="server"></span>
                        </td>
                    </tr>
                </table>
                <div style="text-align:center; font-weight:bold">
                    Please answer all questions in this application.<br />
            ...
            <div id="dvPPE">
                <table class="sectionTable">
                    ...
                    <tr>
                        <td class="rowHeader">
				            SCBA is part of the Project ?
                        </td>
                        <td colspan="3" class="rowData" id="tdSCBAIsPart" runat="server">
					        
				        </td>
                    </tr>
                    <tbody id="tbSCBAPart" runat="server">
                        <tr>
                            <td colspan="4" class="rowHeader">
                ...
                <table class="sectionTable">
                    ...
                    <tr>
                        <td colspan="5" style="padding: 5px">
                            I, as the fiscal agent for the <span id="spDepartmentName" runat="server" style="text-decoration:underline"></span> department, certify <span id="spcertification" runat="server"></span>
                        </td>
                    </tr>
                    <tr>

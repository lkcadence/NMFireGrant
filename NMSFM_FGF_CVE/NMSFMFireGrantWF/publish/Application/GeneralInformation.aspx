...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    <div class="wrapper">
        ...
        <div class="row formRow">
            ...
            <div class="col-md-2">
                <asp:TextBox ID="txtFirefighters" runat="server" class="form-control" TextMode="Number" min="0"></asp:TextBox>
            </div>
            <div class="col-md-2">
                <asp:rangevalidator ID="Rangevalidator1" errormessage="Please enter value between 0-99." forecolor="Red" controltovalidate="txtFirefighters" minimumvalue="0" maximumvalue="99" runat="server" Type="Integer">
                </asp:rangevalidator>
            </div>
        </div>
        <div class="row formRow">
            ...
            <div class="col-md-2">
                <asp:TextBox ID="txtlblFF1" runat="server" class="form-control" TextMode="Number" min="0"></asp:TextBox>
            </div>
            <div class="col-md-2">
                <asp:rangevalidator ID="Rangevalidator3" errormessage="Please enter value between 0-99." forecolor="Red" controltovalidate="txtlblFF1" minimumvalue="0" maximumvalue="99" runat="server" Type="Integer">
                </asp:rangevalidator>
            </div>
        </div>
        <div class="row formRow">
            ...
            <div class="col-md-2">
                <asp:TextBox ID="txtFF2" runat="server" class="form-control" TextMode="Number" min="0"></asp:TextBox>
            </div>
            <div class="col-md-2">
                <asp:rangevalidator ID="Rangevalidator2" errormessage="Please enter value between 0-99." forecolor="Red" controltovalidate="txtFF2" minimumvalue="0" maximumvalue="99" runat="server" Type="Integer">
                </asp:rangevalidator>
            </div>
        </div>
        <div class="row">

...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    <div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <telerik:RadEditor RenderMode="Lightweight" runat="server" ID="txtFinancialNeed" SkinID="DefaultSetOfTools" Width="100%" Height="350px" ContentAreaCssFile="~/Content/EditorStyles.css" StripFormattingOptions="MSWordRemoveAll" ToolsFile="~/Content/NMSFMBasicTools.xml" aria-required="true" DialogHandlerUrl="~/Telerik.Web.UI.DialogHandler.axd">
                </telerik:RadEditor>
            </div>
        </div>
        <div class="row formRow">
        ...
        <div class="row formRow">
            <div class="col-md-12">
                <telerik:RadEditor RenderMode="Lightweight" runat="server" ID="txtProblem" SkinID="DefaultSetOfTools" Width="100%" Height="350px" ContentAreaCssFile="~/Content/EditorStyles.css" StripFormattingOptions="MSWordRemoveAll" ToolsFile="~/Content/NMSFMBasicTools.xml" aria-required="true" DialogHandlerUrl="~/Telerik.Web.UI.DialogHandler.axd">
                </telerik:RadEditor>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row formRow">
            <div class="col-md-12">
                <telerik:RadEditor RenderMode="Lightweight" runat="server" ID="txtBenefit" SkinID="DefaultSetOfTools" Width="100%" Height="350px" ContentAreaCssFile="~/Content/EditorStyles.css" StripFormattingOptions="MSWordRemoveAll" ToolsFile="~/Content/NMSFMBasicTools.xml" aria-required="true" DialogHandlerUrl="~/Telerik.Web.UI.DialogHandler.axd">
                </telerik:RadEditor>  
            </div>
        </div>
        <div class="row">
        ...
        <div class="row formRow">
            <div class="col-md-12">
                <telerik:RadEditor RenderMode="Lightweight" runat="server" ID="txtConsequences" SkinID="DefaultSetOfTools" Width="100%" Height="350px" ContentAreaCssFile="~/Content/EditorStyles.css" StripFormattingOptions="MSWordRemoveAll" ToolsFile="~/Content/NMSFMBasicTools.xml" aria-required="true" DialogHandlerUrl="~/Telerik.Web.UI.DialogHandler.axd">
                </telerik:RadEditor>
            </div>
        </div>
        <div id="dvAdmin" runat="server">
            ...
            <div class="row formRow">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtFinancialNeedGrade" runat="server" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" MaxValue="100"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="lblFinancialNeedComments" runat="server" Text="Financial Need Comments" AssociatedControlID="txtFinancialNeedComments"></asp:Label>
                </div>
                <div class="col-md-6">
                    <asp:TextBox ID="txtFinancialNeedComments" runat="server" TextMode="MultiLine" Rows="7" Width="100%"></asp:TextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtProblemGrade" runat="server" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" MaxValue="100"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="lblProblemComments" runat="server" Text="Problem Comments" AssociatedControlID="txtProblemComments"></asp:Label>
                </div>
                <div class="col-md-6">
                    <asp:TextBox ID="txtProblemComments" runat="server" TextMode="MultiLine" Rows="7" Width="100%"></asp:TextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtBenefitGrade" runat="server" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" MaxValue="100"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="lblBenefitComments" runat="server" Text="Benefit to the Community Comments" AssociatedControlID="txtBenefitComments"></asp:Label>
                </div>
                <div class="col-md-6">
                    <asp:TextBox ID="txtBenefitComments" runat="server" TextMode="MultiLine" Rows="7" Width="100%"></asp:TextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtConsequencesGrade" runat="server" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" MaxValue="100"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="lblConsequencesComments" runat="server" Text="Consequences Comments" AssociatedControlID="txtConsequencesComments"></asp:Label>
                </div>
                <div class="col-md-6">
                    <asp:TextBox ID="txtConsequencesComments" runat="server" TextMode="MultiLine" Rows="7" Width="100%"></asp:TextBox>
                </div>
            </div>
        </div>
        <div class="row">

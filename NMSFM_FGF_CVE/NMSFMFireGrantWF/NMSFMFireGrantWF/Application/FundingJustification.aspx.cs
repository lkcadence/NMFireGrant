...
// private IAccountService accountService; // legacy field, currently unused
            ...
            try
            {
                ...
                else
                {
                    if (Session["Role"].ToString() == "Internal")
                    {
                        ...
                        {
                            txtBenefitGrade.ReadOnly = true;
                            txtConsequencesGrade.ReadOnly = true;
                            txtFinancialNeedGrade.ReadOnly = true;
                            txtProblemGrade.ReadOnly = true;
                        }
                    }
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (appId != null)
                    {
                        ...
                        {
                            await LoadFundingJustification(fundingJustification);
        ...
        private void DisableControls(Control con)
        {
            ...
            if (dvAdmin.Visible)
            {
                ...
                txtBenefitComments.ReadOnly = false;
                txtFinancialNeedComments.ReadOnly = false;
                txtConsequencesComments.ReadOnly = false;
                txtProblemComments.ReadOnly = false;
                
                btnSave.Visible = true;
            }
        }

        private async Task<bool> LoadFundingJustification(FG_App_FundingJustification model)
        {
            try
            {
                ...
                txtFinancialNeedComments.Text = (model.FinancialNeedComments != null) ? model.FinancialNeedComments.ToString() : "";
                txtProblemComments.Text = (model.ProblemComments != null) ? model.ProblemComments.ToString() : "";
                txtBenefitComments.Text = (model.BenefitComments != null) ? model.BenefitComments.ToString() : "";
                txtConsequencesComments.Text = (model.ConsequencesComments != null) ? model.ConsequencesComments.ToString() : "";
                ...
                else
                {
                    if (Convert.ToBoolean(Session["IsWebAdmin"]) == true)
                    {
                        ...
                        {
                            int financialNeedGrade = 0;
                            int problemGrade = 0;
                            int benefitGrade = 0;
                            int consequencesGrade = 0;
                            foreach (DetailedFGAppScores score in appScores)
                            {
                                financialNeedGrade += score.FinancialNeedGrade;
                                problemGrade += score.ProblemGrade;
                                benefitGrade += score.BenefitGrade;
                                consequencesGrade += score.ConsequencesGrade;
                            }
                            lblFinancialNeedGrade.Text = "Average Financial Need Score: ";
                            txtFinancialNeedGrade.Text = financialNeedGrade.ToString();
                            lblProblemGrade.Text = "Average Problem Score: ";
                            txtProblemGrade.Text = problemGrade.ToString();
                            lblBenefitGrade.Text = "Average Benefit Score: ";
                            txtBenefitGrade.Text = benefitGrade.ToString();
                            lblConsequencesGrade.Text = "Average Consequences Score: ";
                            txtConsequencesGrade.Text = consequencesGrade.ToString();
                        }
                    }
                    else
                    {
                        ...
                        if (appScores != null)
                        {
                            txtFinancialNeedGrade.Text = appScores.FinancialNeedGrade.ToString();
                            txtProblemGrade.Text = appScores.ProblemGrade.ToString();
                            txtBenefitGrade.Text = appScores.BenefitGrade.ToString();
                            txtConsequencesGrade.Text = appScores.ConsequencesGrade.ToString();
                        }
                    }
        ...
        private async Task<bool> SaveForm()
        {
            try
            {
                ...
                model.FinancialNeedComments = txtFinancialNeedComments.Text;
                model.ProblemComments = txtProblemComments.Text;
                model.BenefitComments = txtBenefitComments.Text;
                model.ConsequencesComments = txtConsequencesComments.Text;
                ...
                if (retVal == true && dvAdmin.Visible)
                {
                    if (Convert.ToBoolean(Session["IsWebAdmin"]) == false)
                    {
                        ...
                        appScores.FinancialNeedGrade = Convert.ToInt32(txtFinancialNeedGrade.DbValue);
                        appScores.BenefitGrade = Convert.ToInt32(txtBenefitGrade.DbValue);
                        appScores.ProblemGrade = Convert.ToInt32(txtProblemGrade.DbValue);
                        appScores.ConsequencesGrade = Convert.ToInt32(txtConsequencesGrade.DbValue);

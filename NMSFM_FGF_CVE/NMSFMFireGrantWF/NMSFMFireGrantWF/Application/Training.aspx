...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    ...
    <div class="wrapper">
        ...
        <div class="row formRow">
            ...
            <div class="col-md-3">
                <telerik:RadNumericTextBox ID="txtTrainingHours" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" aria-required="true"></telerik:RadNumericTextBox>
            </div>
        </div>
                    ...
                    <MasterTableView>
                        <Columns>
                            <telerik:GridTemplateColumn FilterControlAltText="Filter Edit column" HeaderText="Edit" UniqueName="Edit">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEdit" runat="server" Text="View/Edit" CommandName="ViewEdit" CommandArgument='<%# Eval("TrainingId") %>'>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn FilterControlAltText="Filter Edit column" HeaderText="View" UniqueName="View">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnView" runat="server" Text="View Document" CommandName="View" CommandArgument='<%# Eval("TrainingId") %>'>
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn FilterControlAltText="Filter Edit column" HeaderText="Download" UniqueName="Download">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnDownload" runat="server" Text="Download Doc" CommandName="Download" CommandArgument='<%# Eval("TrainingId") %>'>
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
        ...
        <div id="dvAdmin" runat="server">
            ...
            <div class="row formRow">
                <div class="col-md-5">
                    <asp:Label ID="lblTrainingPoints" runat="server" Text="Regular and adequate training points (max of 20)?" AssociatedControlID="txtTrainingPoints"></asp:Label>
                </div>
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtTrainingPoints" runat="server" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" MinValue="0" MaxValue="20" Type="Number"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-sm-7">
                            <telerik:RadAsyncUpload ID="ruTrainingDoc" runat="server" TabIndex="0" Skin="Bootstrap" MaxFileSize="11000000" MultipleFileSelection="Disabled" MaxFileInputsCount="1" aria-required="true">
                                <FileFilters>
                                    <telerik:FileFilter Description="Documents(jpeg;jpg;gif;png;pdf;docx;txt;rtf)" Extensions="jpeg,jpg,gif,png,pdf,docx,txt,rtf" />
                                </FileFilters>

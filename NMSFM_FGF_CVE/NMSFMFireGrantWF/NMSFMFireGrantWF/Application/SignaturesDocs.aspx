...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    ...
    <div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-8">
                <ol>
                    ...
                    <li>
                        If you are the Fiscal Agent, Fire Chief or Administrative Manager please indicate that you are signing the application and enter your information.
                    </li>
                    <li>
                        Send emails to signers to allow them access to review and sign the application.
                    </li>
                    <li>
            ...
            <hr />
                ...
                <div class="row" id="dvDocumentError" runat="server"></div>
                    <div class="row formRow">
                        <div class="col-sm-3">
                            <asp:Label ID="lblCategory" runat="server" AssociatedControlID="ddlCategory" Text="Document Type: *"></asp:Label>
                        </div>
                        <div class="col-sm-3">
                            <asp:DropDownList ID="ddlCategory" CssClass="form-control" runat="server" ClientIDMode="Static">
                                <asp:ListItem Text="" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Stipend" Value="1">
                                </asp:ListItem>
                                <asp:ListItem Text="Scope of Project/Work" Value="2">
                                </asp:ListItem>
                                <asp:ListItem Text="Specifications" Value="3">
                                </asp:ListItem>
                                <asp:ListItem Text="Other Records/Data" Value="4">
                                </asp:ListItem>
                            </asp:DropDownList>
                            <%--<asp:TextBox ID="txtDocumentType" runat="server"></asp:TextBox>--%>
                        </div>
                        <div class="col-sm-6">
                            <p><i>Max File Size: 10MB - File Types: PDF, Image, Word Document, Text, Rich Text</i></p>
                        </div>
                    </div>
                    <div class="row formRow">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <telerik:RadAsyncUpload ID="fuDocumentation" runat="server" TabIndex="0" Skin="Bootstrap" MaxFileSize="10000000" MultipleFileSelection="Disabled" MaxFileInputsCount="1" OnClientFileUploaded="OnFileSelected" OnClientFileUploadRemoved="OnFileSelected">
                                <FileFilters>
                                    <telerik:FileFilter Description="Images(jpeg;jpg;gif;png;pdf;docx;txt;rtf)" Extensions="jpeg,jpg,gif,png,pdf,docx,txt,rtf" />
                                </FileFilters>
                            </telerik:RadAsyncUpload>
                        </div>
                    </div>
                    <div class="row formRow" id="dvAddDocumentLink" style="display:none">
                        <div class="col-md-10" id="dvAddDocument" runat="server">
                            <asp:LinkButton ID="lnkAddDocument" runat="server" Text="Upload Document" OnClick="lnkAddDocument_Click" ClientIDMode="Static"></asp:LinkButton><br />
                            <span><i> (Note: You must click the Upload Document link in order to save your document to the application. If the circle next to the document name above is red then the document is too large or the wrong file type.)</i></span>
                        </div>
                    </div>
                    <div class="row formRow">
                        <div class="col-md-3">
                            ...
                            <telerik:RadGrid ID="rgDocuments" runat="server" AutoGenerateColumns="False" GroupPanelPosition="Top" Skin="Bootstrap" AllowPaging="True" PageSize="10" OnNeedDataSource="rgDocuments_NeedDataSource" OnPageIndexChanged="rgDocuments_PageIndexChanged" OnItemDataBound="rgDocuments_ItemDataBound" OnItemCommand="rgDocuments_ItemCommand">
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn FilterControlAltText="Filter Edit column" HeaderText="Download" UniqueName="Download">
                                            <ItemTemplate>
        ...
        <div class="row formRow" id="dvSubmitInstructions" runat="server" visible="false">
            <div class="col-md-10 card card-body" id="dvSubmitInstructionsBody" runat="server">
        ...
        <div class="row">
            <hr />
            <asp:HiddenField ID="hfIsFireChief" runat="server" Value="false" />
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-sm-7">
                            <asp:DropDownList ID="ddlSignatureRole" runat="server" ClientIDMode="Static">
                                ...
                                <asp:ListItem Text="Administrative Manager" Value="Administrative Manager"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="row formRow" id="dvAgreement">
                        <div class="col-md-1">
                            <asp:CheckBox ID="chkAgreement" runat="server" ClientIDMode="Static" /><br />
                        </div>
                        <div class="col-md-9">
                            <asp:Label ID="lblAgreement" runat="server" ClientIDMode="Static" AssociatedControlID="chkAgreement">I HAVE READ AND UNDERSTAND THIS AGREEMENT, AND I ACCEPT AND AGREE TO ALL OF ITS TERMS AND CONDITIONS.</asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="row formRow" id="dvSignature">
                        <div class="col-sm-5">
                            <asp:Label ID="lblSignature" runat="server" ClientIDMode="Static" AssociatedControlID="txtSignature" Text="Type Signature: *"></asp:Label>
                        </div>
                        <div class="col-sm-7">
                    ...
                    <asp:HiddenField ID="hfDeptName" runat="server" ClientIDMode="Static" />
                    <asp:HiddenField ID="hfSignatureId" runat="server"/>
                    <asp:HiddenField ID="hfLoginToken" runat="server" />
                    <asp:HiddenField ID="hfSignatureDate" runat="server" />
                    <asp:HiddenField ID="hfFASigCert" runat="server" ClientIDMode="Static" Value="that any funds in excess of the requested grant amount required to complete the project as specified are committed for use with respect to this application."/>
                </div>
    ...
    <!-- Modal 3 -->
    <div class="modal fade" id="imgModal" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="lblImgModalHeader" aria-hidden="true">
        <div class="modal-dialog" role="document" style="width:fit-content; height:fit-content">
            <div class="modal-content">
                <div class="modal-header" id="modalHeader3">
                    <h4 class="modal-title" id="lblImgModalHeader">View Image</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" style="background-color:lightgray">
                    <img id="imgDocument" runat="server" width="600" />
                </div>
                <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function clearNoteId() {
            $('#ddlSignatureRole').val('');
            $('#chkSelfSign').prop('checked', false);
            ...
            $('#txtPrintedName').val('');
            $('#txtEmail').val('');
            var otherText = "I HAVE READ AND UNDERSTAND THIS AGREEMENT, AND I ACCEPT AND AGREE TO ALL OF ITS TERMS AND CONDITIONS.";
            $('lblSignature').text("Type Signature: *")
            $('#lblAgreement').text(otherText);
        ...
        function ShowFAAgreement() {
            var department = $('#hfDeptName').val();
            var faSigCert = $('#hfFASigCert').val();
            var faSigText = "I, as fiscal agent for " + department + ", certify " + faSigCert;
            var otherText = "I HAVE READ AND UNDERSTAND THIS AGREEMENT, AND I ACCEPT AND AGREE TO ALL OF ITS TERMS AND CONDITIONS.";
            var sigType = $('#ddlSignatureRole').val();
            if (sigType === "Fiscal Agent") {
                $('#lblSignature').text('E-signature of Fiscal agent: *')
                $('#lblAgreement').text(faSigText);
            }
            else {
                $('lblSignature').text("Type Signature: *")
                $('#lblAgreement').text(otherText);
        ...
        $('#ddlSignatureRole').change(function () {
            ShowFAAgreement();
        });

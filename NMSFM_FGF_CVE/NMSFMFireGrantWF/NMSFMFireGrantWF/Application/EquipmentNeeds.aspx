            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-md-2">
                            <asp:rangevalidator ID="Rangevalidator3" errormessage="Please enter value between 0 and 1000." forecolor="Red" controltovalidate="txtEquipmentQty" minimumvalue="0" maximumvalue="1000" runat="server" Type="Integer">
                            </asp:rangevalidator>
                        </div>
                    </div>
                    <div class="row formRow">
                        ...
                        <div class="col-sm-3">
                            <telerik:RadNumericTextBox ID="txtEquipmentCost" runat="server" ClientIDMode="Static" NumberFormat-DecimalDigits="2" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0"></telerik:RadNumericTextBox>
                        </div>
                    </div>

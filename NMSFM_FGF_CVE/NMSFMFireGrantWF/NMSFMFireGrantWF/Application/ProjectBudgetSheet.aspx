...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    <div class="wrapper">
        ...
        <div class="row formRow">
            <div class="col-md-5">
                <asp:Label ID="lblEquipments" runat="server" Text="Will fulfilling this need impact your organization's ISO rating?" AssociatedControlID="fldISORating"></asp:Label>
            </div>
            <div class="col-md-3">
                ...
                <div class="container container-fluid" style="width:auto;">
                    <div class="row formRow">
                        ...
                        <div class="col-md-3" style="text-align:right">
                            <telerik:RadNumericTextBox ID="txtTotalAmount" runat="server" CssClass="form-control" ClientIDMode="Static" NumberFormat-DecimalDigits="2" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0"></telerik:RadNumericTextBox>
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-md-3" style="text-align:right">
                            <telerik:RadNumericTextBox ID="txtAmountRequested" runat="server" CssClass="form-control" ClientIDMode="Static" NumberFormat-DecimalDigits="2" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" MinValue="0" aria-required="true"></telerik:RadNumericTextBox>
                        </div>
                    </div>
                    <%--<div class="row">
                        <div class="col-md-9" style="text-align:right">
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-md-3" style="text-align:right">
                            <telerik:RadNumericTextBox ID="txtTotalDeptResp" runat="server" CssClass="form-control" ClientIDMode="Static" NumberFormat-DecimalDigits="2" NumberFormat-GroupSeparator="," EmptyMessage="0" MinValue="0" Type="Number" ReadOnly="true"></telerik:RadNumericTextBox>
                        </div>
                    </div>
                    <div class="row">
                        <hr />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="text-align:right">
                            <telerik:RadNumericTextBox ID="txtStipendAmountRequested" runat="server" CssClass="form-control" ClientIDMode="Static" NumberFormat-DecimalDigits="2" NumberFormat-GroupSeparator="," EmptyMessage="0" MinValue="0" Type="Number" aria-required="true"></telerik:RadNumericTextBox>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function calcBudget() {
            var projCostString = $("#txtTotalAmount").val().replace('$', '').replaceAll(',', '');
            var projectCost = Number(projCostString);
            var grantRequest = Number($("#txtAmountRequested").val().replace('$', '').replaceAll(',', ''));
        ...
        $("#txtAmountRequested,#txtTotalAmount").keyup(function () {
            calcBudget()
        });
    </script>
</asp:Content>

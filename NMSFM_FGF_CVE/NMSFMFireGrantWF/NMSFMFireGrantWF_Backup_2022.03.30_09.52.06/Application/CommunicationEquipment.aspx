    ...
    <div class="wrapper">
        ...
        <div id="dvCommunications">
            ...
            <div class="row formRow">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtHandheldRadios" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtBaseStations" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <telerik:RadNumericTextBox ID="txtMobileRadios" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number"></telerik:RadNumericTextBox>
                </div>
            </div>
            <div class="row formRow">
                <div class="col-md-5">
            ...
            <div class="row" id="dvCommunicationEquipHead">
                <div class="col-md-12">
                    <h3>List Communication Equipment by Type</h3>
                </div>
            </div>
            ...
            <div class="row formRow" id="dvOtherDescription">
                <div class="col-md-5">
                    <asp:Label ID="lblOtherDesc" runat="server" Text="Describe (if 'yes' on others or any additional comments)?" AssociatedControlID="txtOtherDescription"></asp:Label>
                </div>
                <div class="col-md-3">
            ...
            <div class="row formRow" id="dvRepeaterDescription">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtRepeaterDescription" runat="server" CssClass="form-control" ClientIDMode="Static" TextMode="MultiLine" Rows="5" Width="100%"></asp:TextBox>
                </div>
            </div>
        </div> 

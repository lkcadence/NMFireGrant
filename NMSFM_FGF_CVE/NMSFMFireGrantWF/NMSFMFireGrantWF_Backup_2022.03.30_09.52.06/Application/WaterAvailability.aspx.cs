    ...
    public partial class WaterAvailability : System.Web.UI.Page
    {
        ...
        private async Task<bool> SaveForm()
        {
            try
            {
                ...
                if (txtTotalWaterCapacity.Text == "" || Convert.ToDecimal(txtTotalWaterCapacity.DbValue) < 1 )
                {
                    errorMessage += "Total Water Capacity is Required.<br />";
                    isValid = false;
                }
                if (txtWaterCapacityWheels.Text == "" || Convert.ToDecimal(txtWaterCapacityWheels.DbValue) < 1)
                {
                    errorMessage += "Total Capacity on Wheels is Required.<br />";
                    isValid = false;
                }
                if (txtWaterCapacityStation.Text == "" || Convert.ToDecimal(txtWaterCapacityStation.DbValue) < 1)
                {
        ...
        protected void btnSaveWaterSource_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                waterSource.Number = Convert.ToInt32(txtWaterSourceNumber.Text);

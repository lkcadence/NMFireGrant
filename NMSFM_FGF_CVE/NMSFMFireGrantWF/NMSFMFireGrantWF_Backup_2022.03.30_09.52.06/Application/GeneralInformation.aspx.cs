    ...
    public partial class GeneralInformation : System.Web.UI.Page
    {
        ...
        private void LoadGeneralInfoData(FG_App_GeneralInfo model)
        {
            try
            {
                ...
                if (model.NFIRSID != "") { txtFDID.Text = model.NFIRSID; }
                ...
                else if (model.DeptType == 3) { chkSubUrban.Checked = true; }
        ...
        private async Task<bool> SaveForm()
        {
            try
            {
                ...
                {
                    errorMessage += "Fire Department ID (NFIRS ID) is Required. <br />";
                    isValid = false;
                }
                ...
                if (rbCountyWide.Checked)
                {
                    ...
                    {
                        errorMessage += "You must specify if all of the County departments NFIRS and Pump Test complient. <br />";
                        isValid = false;
                    }
                }

...
<asp:Content ID="Content3" ContentPlaceHolderID="ApplicationContent" runat="server">
    <div class="wrapper">
        ...
        <div class="row formRow">
            ...
            <div class="col-md-3">
                <telerik:RadNumericTextBox ID="txtHomesProtected" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" aria-required="true"></telerik:RadNumericTextBox>
            </div>
        </div>
        <div class="row formRow">
            <div class="col-md-5">
            ...
            <div class="col-md-3">
                <telerik:RadNumericTextBox ID="txtCommercial" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" aria-required="true"></telerik:RadNumericTextBox>
            </div>
        </div>
        <div class="row formRow">
            <div class="col-md-5">
            ...
            <div class="col-md-3">
                <telerik:RadNumericTextBox ID="txtPopulation" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="," EmptyMessage="0" Type="Number" aria-required="true"></telerik:RadNumericTextBox>
            </div>
        </div>
        <div class="row formRow">
            <div class="col-md-5">
        ...
        <div class="row" id="dvAidAgreementsHeader">
            <div class="col-md-12">
                <h3>List adjacent automatic aid fire districts (with written agreements)</h3>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row formRow">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtDistrictNumber" runat="server" class="form-control" Width="250px" ClientIDMode="Static" TextMode="Number" aria-required="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row formRow">
                        <div class="col-sm-3">

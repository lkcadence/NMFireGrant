        ...
        protected void rgApparatus_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    string comment = dataItem["Comments"].Text;
            ...
            { 
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            errorMessage += "GPM must be greater than 0.<br />";
                            isValid = false;
                        }
                    }
                    catch
                ...
                {
                    errorMessage += "Pass/Fail is required<br />";
                    isValid = false;
                }
                ...
                apparatus.Number = Convert.ToInt32(txtNumber.Text);
                ...
                apparatus.License = txtLicense.Text;

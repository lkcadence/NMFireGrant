    ...
    public partial class ManageSettings : System.Web.UI.Page
    {
        ...
        protected async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Program Settings have been saved</span></div>";
                }
        ...
        protected async void btnSaveReqDoc_Click(object sender, EventArgs e)
        {
            try
            {
                if (fuReqDoc.PostedFiles.Count != 0)
                {
                    ...
                    if (fuReqDoc.PostedFile.ContentType.ToString() == "image/jpeg" | fuReqDoc.PostedFile.ContentType.ToString() == "image/png" | fuReqDoc.PostedFile.ContentType.ToString() == "image/bmp" | fuReqDoc.PostedFile.ContentType.ToString() == "application/pdf")
                    {
                        isCorrectFormat = true;
                    }
                    if (isCorrectFormat == false)
                    {
                        throw new Exception("Images must be in the format of .pdf, .jpg, .png or .bmp<br />");
                    }
                }
                else
                {
                ...
                if (await fgService.UpdateFireGrantMainSettings(result) == true)
                {
                    ...
                    if (uploaded)
                    {
                        ...
                        dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Requirements Document has been saved</span></div>";
                    }
        ...
        protected async void btnSavePageContent_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (await fgService.UpdateFireGrantMainSettings(result) == true)
                {
                    dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Initial Page Content has been saved</span></div>";
                }
        ...
        protected async void btnSaveDefaultPageContent_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (await fgService.UpdateFireGrantMainSettings(result) == true)
                {
                    dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Default Page Content has been saved</span></div>";
                }
        ...
        protected async void btnSaveTestStatutes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (await fgService.UpdateFireGrantMainSettings(result) == true)
                {
                    dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Pump/Hose Test statutes have been saved</span></div>";
                }
        ...
        protected async void btnSaveEligibilityRequirements_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (await fgService.UpdateFireGrantMainSettings(result) == true)
                {
                    dvError.InnerHtml = "<div class='col-md-10'><span class='alert alert-success'>The Eligibility Requirements have been saved</span></div>";
                }
